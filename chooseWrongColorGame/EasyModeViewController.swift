...
//            setTimeForProgressView()
    ...
    private func pushToEasyMode(){
        ...
        navigationController?.pushViewController(easyModeViewController, animated: false)
    }
...
extension EasyModeViewController: UICollectionViewDelegate,UICollectionViewDataSource{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let wrongColorCollectionViewCell: WrongColorCollectionViewCell = collectionView.dequeueReusableCell(withReuseIdentifier: "WrongColorCollectionViewCell", for: indexPath) as! WrongColorCollectionViewCell
        if  wrongColorIndex == indexPath.row {
            righIndex = indexPath.row
            wrongColorCollectionViewCell.colorNameLabel.text = arrShowColour[rightColorIndex] as? String
            wrongColorCollectionViewCell.backgroundColor = arrShowUIColore[wrongColorIndex] as? UIColor
            wrongColorCollectionViewCell.layer.cornerRadius = 15
            wrongColorCollectionViewCell.layer.masksToBounds = true
            
        }else{
            wrongColorCollectionViewCell.colorNameLabel.text = arrShowColour[indexPath.row] as? String
            wrongColorCollectionViewCell.backgroundColor = arrShowUIColore[indexPath.row] as? UIColor
            wrongColorCollectionViewCell.layer.cornerRadius = 15
            wrongColorCollectionViewCell.layer.masksToBounds = true
        }
        setupProgressBar()
        
        return wrongColorCollectionViewCell
    }
